...
export var Page = function (_a) {
    ...
    return (React.createElement("article", null,
        React.createElement(Header, { user: user, onLogin: onLogin, onLogout: onLogout, onCreateAccount: onCreateAccount }),
        React.createElement("section", null,
            ...
            React.createElement("p", null,
                ...
                ' ',
                React.createElement("a", { href: "https://www.learnstorybook.com", target: "_blank", rel: "noopener noreferrer" }, "Learn Storybook"),
                ". Read more in the",
                ' ',
